...
const renderPagination = (totalItems) => {
  ...
  if (objectModules$1.pagination) {
    objectModules$1.pagination.paginationInit();
  }
};
...
const initSliders$1 = () => {
  ...
  if (reviewSlider) {
    new Swiper(".slider-reviews", {
      modules: [Navigation, Pagination2],
      observer: true,
      observeParents: true,
      slidesPerView: 1,
      spaceBetween: 20,
...
const initPaginatons = () => {
  ...
  if (paginationArray.length > 0) {
    paginationArray.forEach((paginationItem) => objectModules$1.pagination = new Pagination$1(paginationItem));
  }
    ...
    mdQueriesArray.forEach((mdQueriesItem) => {
      mdQueriesItem.matchMedia.addEventListener("change", () => {
        mdQueriesItem.itemsArray.forEach(
          (paginationItem) => objectModules$1.pagination = new Pagination$1(paginationItem.item, mdQueriesItem.matchMedia)
        );
      });
      mdQueriesItem.itemsArray.forEach(
        (paginationItem) => objectModules$1.pagination = new Pagination$1(paginationItem.item, mdQueriesItem.matchMedia)
...
if (document.querySelector("[data-watcher]")) {
  objectModules$1.watcher = new ScrollWatcher({});
}
if (document.querySelector("[data-form-validation]")) {
  objectModules$1.formsValidation = new FormsValidation({
    on: {
      formSend: (form) => {
...
if (document.querySelector("[data-modal]")) {
  objectModules$1.modal = new Modal({});
}
